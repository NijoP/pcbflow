...
|---|---|---|---|
| G1 | **Branding wrong** — docs said "AXON" (unsuitable codename); repo named "easyeda-plugin" (it is neither an EasyEDA plugin nor well-named) | High | [`../BRANDING.md`](../BRANDING.md) + rebrand to **Tracewright** |
...
rebranded to **Tracewright**, and a product [`ROADMAP.md`](../ROADMAP.md) was added. The
