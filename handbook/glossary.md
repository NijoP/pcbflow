...
You rarely need these to use PCB Flow, but here they are whenever a word is unfamiliar.
...
| **Repository (repo)** | A folder of files that also keeps its full history. This whole PCB Flow folder is a repository. |
...
| **Terminal** | A text box where you type commands. In PCB Flow the AI uses it; you rarely do. |
...
| **Prompt** | A message you send the AI. In PCB Flow, just plain English describing what you want. |
...
| **Phase / Step** | One of the 12 stages of the PCB Flow workflow. |
